...
#MongoDB Connection
client = pymongo.MongoClient("mongodb+srv://hariprasathbabu:hariprasathbabumongodb@cluster0.icdljd3.mongodb.net/?retryWrites=true&w=majority")
